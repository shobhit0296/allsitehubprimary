        ...
        <div className="w-full min-w-0">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-2.5 sm:gap-3 mb-6 sm:mb-8 w-full">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="social-cta-btn social-cta-telegram group w-full sm:w-auto min-w-0 sm:min-w-[160px] touch-manipulation"
              aria-label="Join our Telegram group"
            >
              <span className="social-cta-icon-wrap social-cta-telegram-icon">
                <TelegramIcon />
              </span>
              <span className="flex flex-col items-start leading-tight">
                <span className="text-[10.5px] font-semibold text-white/55 tracking-wide uppercase">Join us on</span>
