      ...
      <div className="pt-0.5">
        <div className="grid grid-cols-3 gap-2">
          ...
          <a
            ...
            className="flex items-center justify-center h-10 rounded-xl bg-white/[0.025] hover:bg-[#229ED9]/15 border border-white/[0.06] hover:border-[#229ED9]/45 text-[#229ED9] hover:text-white transition-all duration-200 group shadow-sm hover:shadow-[0_0_16px_rgba(34,158,217,0.25)] active:scale-95"
          >
            <span className="transition-transform duration-200 group-hover:scale-110">
              <TelegramIcon />
            </span>
