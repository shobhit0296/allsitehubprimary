...
export const THEMES: ThemeOption[] = [
  {
    ...
    bgRgb: [0.018, 0.018, 0.025],
    accentRgb: [0.655, 0.545, 0.98],
    accent2Rgb: [0.22, 0.74, 0.97],
    vars: {
      '--bg-base': '#050507',
      '--bg-surface': '#0a0a0e',
      '--bg-card': 'rgba(13, 13, 17, 0.76)',
      '--bg-card-hover': 'rgba(20, 20, 26, 0.92)',
    ...
    desc: 'Matte Obsidian & Royal Violet',
  },
  {
    id: 'cyberpunk',
    name: 'Cyber Neon',
  ...
  },
  {
    ...
    bgRgb: [0.012, 0.012, 0.016],
    accentRgb: [0.886, 0.910, 0.941],
    accent2Rgb: [0.580, 0.639, 0.722],
    vars: {
      '--bg-base': '#040405',
      '--bg-surface': '#08080a',
      '--bg-card': 'rgba(14, 14, 18, 0.82)',
      '--bg-card-hover': 'rgba(22, 22, 28, 0.94)',
      '--border': 'rgba(255, 255, 255, 0.09)',
      '--border-accent': 'rgba(226, 232, 240, 0.7)',
      '--primary': '#e2e8f0',
      '--secondary': '#94a3b8',
      '--text-primary': '#ffffff',
    ...
    desc: 'Pure Matte Black & Stealth Onyx',
  },
];
